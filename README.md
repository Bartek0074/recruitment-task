# Zadanie Rekrutacyjne: Komponent Slidera
...
- **Dynamiczne dane (CMS):** Treści wyświetlane w sliderze muszą być zasilane z zewnętrznego pliku `sampleData.json`. Symuluje to pobieranie danych z systemu CMS. Pamiętaj, że dane mogą ulec zmianie, więc Twój kod powinien być elastyczny i gotowy na różne warianty.
